...
abstract class AbstractSinglePageController implements ControllerInterface
{
    ...
    {
        if (
            SnapUtil::filterInputRequest('page', FILTER_SANITIZE_STRING) !== $this->pageSlug ||
    ...
    public function registerMenu()
    {
        ...
        $this->menuHookSuffix = add_submenu_page(null, $pageTitle, '', $this->capatibility, $this->pageSlug, array($this, 'render'));
