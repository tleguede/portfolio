                    ...
                    if ($is_freelancer_plus) :
                        ...
                        <select name="installer_opts_brand" id="installer_opts_brand" onchange="DupPro.Template.BrandChange();">
                            ...
                            foreach ($brands as $i => $brand) :
                                ?>
                                <option value="<?php echo esc_attr($brand->id); ?>" title="<?php echo esc_attr($brand->notes); ?>"<?php if (isset($_REQUEST['inner_page']) && $_REQUEST['inner_page'] == 'edit') { selected($brand->id, $active_brand_id); } ?>>
...
<button class="button button-primary dup-save-template-btn" type="submit"><?php DUP_PRO_U::esc_html_e('Save Template'); ?></button>
</form>
