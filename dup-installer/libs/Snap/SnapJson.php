...
class SnapJson
{
    ...
    public static function jsonEncode($data, $options = 0, $depth = 512)
    {
        ...
        $args[0] = self::jsonPrepareData($data);
        ...
        try {
            $args[0] = self::jsonSanityCheck($data, $depth);
        } catch (\Exception $e) {
            return false;
        }
    ...
    {
        if (
            !defined('SNAP_WP_JSON_SERIALIZE_COMPATIBLE') ||
            SNAP_WP_JSON_SERIALIZE_COMPATIBLE === false ||
